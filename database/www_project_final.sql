...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 23, 2022 at 04:18 AM
...
INSERT INTO `customers` (`customerid`, `name`, `address`, `city`, `zip_code`, `country`, `password`) VALUES
(1, 'a', 'a', 'a', 'a', 'a', ''),
(2, 'b', 'b', 'b', 'b', 'b', ''),
(3, 'test', '123 test', '12121', 'test', 'test', ''),
(4, 'Shreyansh', 'Hotwar', 'Ranchi', '835217', 'India', ''),
(5, 'Shreyansh', 'Hotwar', 'Ranchi', '835217', 'India', ''),
(6, 'Shreyansh', 'Hotwar', 'Ranchi', '835217', 'India', '123ABCD'),
(7, 'Sachin', 'VILLAGE SARLA KALAN', 'GOLA', '829110', 'India', 'jsgbcf');
